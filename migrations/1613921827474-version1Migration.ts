...
export class version1Migration1613921827474 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "advertisement" ("id" SERIAL NOT NULL, "type" character varying NOT NULL, "level" character varying NOT NULL, "title" character varying NOT NULL, "description" character varying NOT NULL, "color" character varying NOT NULL, "price" integer NOT NULL, "country" character varying NOT NULL, "city" character varying NOT NULL, "creationDate" TIMESTAMP NOT NULL DEFAULT '"2021-02-21T15:37:17.078Z"', "isDeleted" boolean NOT NULL DEFAULT false, "deletionDate" TIMESTAMP, "creatorId" integer, CONSTRAINT "PK_c8486834e5ef704ec05b7564d89" PRIMARY KEY ("id"))`);
